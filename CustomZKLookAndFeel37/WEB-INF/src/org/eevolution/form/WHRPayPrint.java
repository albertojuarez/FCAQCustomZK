...
public class WHRPayPrint extends HRPayPrint implements IFormController, EventListener
{
	...
	private void dynInit()
	{
		...
		if (fPaySelect.getItemCount() == 0)
			FDialog.info(m_WindowNo, form, "VHRPayPrintNoRecords");
		else
		{
	...
	private void cmd_print()
	{
		...
		//if (FDialog.ask(m_WindowNo, form, "VPayPrintPrintRemittance")) // ogomezislas direct for UACM!
		//{
		...
		//}	//	remittance	ogomezislas direct for UACM
