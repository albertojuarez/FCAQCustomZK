...
//        txtPassword.setMaxlength(40);
        ...
        //Begin Only languages: IsBaseLanguage or IsSystemLanguage. Jos’as Vargas, e-evolution, 06-04-2012
        	List <MLanguage> languagesQuery = new Query(Env.getCtx(),"AD_Language","IsBaseLanguage='Y' OR IsSystemLanguage='Y'",null).list();
        	for (MLanguage language : languagesQuery){
        		Language l = Language.getLanguage(language.getAD_Language());
    				lstLanguage.appendItem(l.getName(), language.getAD_Language());
        	}	
    	//}
		//Begin Only languages: IsBaseLanguage or IsSystemLanguage. Jos’as Vargas, e-evolution, 06-04-2012
