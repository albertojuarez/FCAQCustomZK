...
DataStatusListener, IADTabpanel, VetoableChangeListener
{
    ...
    public void onEvent(Event event)
    {
		...
		if(event.getTarget() == this)
		{
			...
			if(getGlobalToolbar().getActualPanel()!=null)
				getGlobalToolbar().getActualPanel().setUnselected();
			
			setSelected();
			
			getGlobalToolbar().setActualPanel(this);

			getGlobalToolbar().setCurrentTab(this);
			
			if(gridTab.getAD_Tab_ID() != getGlobalToolbar().getCurrentTab().getGridTab().getAD_Tab_ID())
			{
    ...
    {
    	((HtmlBasedComponent)listPanel).setStyle("border:none;");
		((HtmlBasedComponent)grid).setStyle("border:none;");
    ...
    public void setSelected()
    {
    	...
    	//if(getGlobalToolbar().getActualPanel() == this)
    		//return;
