...
public class StatusBarPanel extends Panel implements EventListener, IStatusBar
{
	...
	private void showPopup() {
		...
		//Add AJC e-Evolution
		script += "var l = $e('" + getRoot().getUuid() + "');";
		script += "var lhs = document.defaultView.getComputedStyle(l, null).getPropertyValue('width');";
		script += "var lh = parseInt(lhs, 10);";
		script += "var dws = document.defaultView.getComputedStyle(d, null).getPropertyValue('width');";
		script += "var dw = parseInt(dws, 10);";
		//
