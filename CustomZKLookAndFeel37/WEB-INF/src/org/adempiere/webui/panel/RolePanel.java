...
public class RolePanel extends Window implements EventListener, Deferrable
{
	...
	private void init()
	{
		...
		//BEGIN AJC e-Evolution  4 FEB 2011
		ConfirmPanel pnlButtons = new ConfirmPanel(false);
		pnlButtons.setVisible(ConfirmPanel.A_OK, false);
		pnlButtons.addComponentsRight(pnlButtons.createButton(ConfirmPanel.A_CANCEL));
		pnlButtons.addComponentsRight(pnlButtons.createButton(ConfirmPanel.A_OK));
		//END AJC e-Evolution  4 FEB 2011
